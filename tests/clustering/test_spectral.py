...
# ==============================================================================
# test_SpectralConstrainedClustering_cluster_model_SPEC_with_verbose_output
# ==============================================================================
def test_SpectralConstrainedClustering_cluster_model_SPEC_with_verbose_output():
    """
    Test that the `clustering.spectral.SpectralConstrainedClustering` clustering works with SPEC `model` and verbose output.
    """
