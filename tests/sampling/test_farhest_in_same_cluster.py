...
"""
* Name:         interactive-clustering/tests/sampling/farhest_in_same_cluster.py
* Description:  Unittests for the `sampling.farhest_in_same_cluster` module.
* Author:       Erwan Schild
* Created:      17/03/2021
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_for_correct_settings
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_for_correct_settings():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` works for correct settings.
    """
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_sample_for_incorrect_nb_to_select
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_sample_for_incorrect_nb_to_select():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` sampling raises `ValueError` for incorrect `nb_to_select`.
    """
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_sample_for_zero_nb_to_select
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_sample_for_zero_nb_to_select():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` sampling works for zero `nb_to_select`.
    """
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_sample_for_incorrect_clustering_result
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_sample_for_incorrect_clustering_result():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` sampling raises `ValueError` for incorrect `clustering_result`.
    """
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_sample_for_incorrect_vectors
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_sample_for_incorrect_vectors():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` sampling raises `ValueError` for incorrect `vectors`.
    """
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_sample_for_correct_constraints_manager
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_sample_for_correct_constraints_manager():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` sampling works for correct `constraints_manager`.
    """
...
# ==============================================================================
# test_FarhestInSameClusterConstraintsSampling_sample_for_full_annotated_constraints_manager
# ==============================================================================
def test_FarhestInSameClusterConstraintsSampling_sample_for_full_annotated_constraints_manager():
    """
    Test that the `sampling.farhest_in_same_cluster.FarhestInSameClusterConstraintsSampling` sampling works for full annotated `constraints_manager`.
    """
